package main.java.ru.brown.controller;
...
/*
 * the login servlet processes login.jsp. The servlet has one
job which is to validate the user and add them to the session so
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        /* get an instance of the session so we can set attributes to it the JSP and
        NavBar will read from the session The session is one of the primary ways we maintain state
        in an otherwise stateless web application */
        HttpSession session = request.getSession();
        //create an instance of the user and put it in the session
        //only add the user to the session if the user is valid.
        // The presence of the user is used to determine
        // who owns the site and will be used to connect to the database
        ...
        //redirect to next page as indicated by the value of the nextURL variabled
